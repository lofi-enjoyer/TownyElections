...
import me.lofienjoyer.TownyElections.commands.GovernmentCommandHandler;
...
import me.lofienjoyer.TownyElections.commands.ElectionsCommandHandler;
import me.lofienjoyer.TownyElections.commands.PartyCommandHandler;
import me.lofienjoyer.TownyElections.commands.TElectCommandHandler;
import me.lofienjoyer.TownyElections.elections.ElectionManager;
import me.lofienjoyer.TownyElections.listeners.TElectTabCompleter;
import me.lofienjoyer.TownyElections.metrics.TEMetrics;
...
public class TownyElections extends JavaPlugin {
	...
	public static String getMessage(String key) {
		return ChatColor.translateAlternateColorCodes('&', instance.getLanguageData().getString("prefix") + instance.getLanguageData().getString(key));
	}
